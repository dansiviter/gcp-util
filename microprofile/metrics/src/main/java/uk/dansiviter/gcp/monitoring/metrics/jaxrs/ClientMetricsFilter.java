 ...
 */
package uk.dansiviter.gcp.monitoring.metrics.jaxrs;

import static java.time.Instant.now;
import static org.eclipse.microprofile.metrics.MetricRegistry.Type.APPLICATION;
import static uk.dansiviter.gcp.monitoring.metrics.Factory.registryType;
import static uk.dansiviter.gcp.monitoring.metrics.Factory.tag;
import static uk.dansiviter.gcp.monitoring.metrics.jaxrs.Metrics.REQUEST_COUNT;
import static uk.dansiviter.gcp.monitoring.metrics.jaxrs.Metrics.RESPONSE_COUNT;
import static uk.dansiviter.gcp.monitoring.metrics.jaxrs.Metrics.RESPONSE_LATENCY;
import static uk.dansiviter.gcp.monitoring.metrics.jaxrs.Metrics.path;
import static uk.dansiviter.gcp.monitoring.metrics.jaxrs.Metrics.status;
import static uk.dansiviter.gcp.monitoring.metrics.jaxrs.Metrics.targetHost;
