 ...
 */
public class StackdriverSpanContextTest {
	@Test
	public void builder_str() {
		final StackdriverSpanContext.Builder builder = StackdriverSpanContext.builder("463ac35c9f6413ad48485a3953bb6124", "05e3ac9a4f6e3b90");

		final StackdriverSpanContext ctx = builder.build();
	...
	public void builder_long() {
		final StackdriverSpanContext.Builder builder = StackdriverSpanContext.builder(OptionalLong.of(123L), 321L, 987L);
